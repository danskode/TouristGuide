...
public class TouristGuideRepository {
    ...
    public TouristGuideRepository() {
        ...
        touristAttractions.add(new TouristAttraction("Ørestad", "En ny og familievenlig bydel i København med moderne arkitektur omringet af natur.", "https://www.wonderfulcopenhagen.com/sites/wonderfulcopenhagen.com/files/2021-05/kalvebod_faelled_orestad3.jpg", 0, "København", List.of("Børnevenlig", "Arkitektur", "Natur")));
